...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Selam Tatlım"],
			morning: ["Günaydın", "Günün güzel geçsin", "Nasıl iyi uyudun mu?"],
			afternoon: ["Merhaba Tatlım", "Çok güzel görünüyorsun:)", "Bugün de iyi görünüyorsun."],
			evening: ["Wow, you look wonderful!", "You look nice!", "Hi, beauty:)"],
